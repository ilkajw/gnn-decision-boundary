...
if __name__ == "__main__":
    ...
    run_step("03_training_org_ds.py",
             f"Path graph sequences done. Training {MODEL} on {DATASET_NAME}...")

    run_step("04_classify_org_ds.py",
    ...
    run_step("08_path_length_stats_by_num_flips.py",
             "Calculating path length statistics by number of flips...")

    run_step("09_num_flips_histograms.py",
             "Calculating number of flips distribution...")

    run_step("10_flip_order_distr.py",
    ...
    run_step("13_plot_flip_order_distr.py",
             "Plotting flip order distributions...")

    run_step("14_plot_flip_distr_with_ops.py",
             "Plotting flip distributions with operations...")

    run_step("15_plot_op_heatmaps.py",
