from analyse_utils import get_distance_per_path, flip_occurrences_per_path, get_num_ops_per_path
...
if __name__ == "__main__":
    ...
    flip_occurrences_per_path(input_dir=f"data/{DATASET_NAME}/predictions/edit_path_graphs_with_predictions",
